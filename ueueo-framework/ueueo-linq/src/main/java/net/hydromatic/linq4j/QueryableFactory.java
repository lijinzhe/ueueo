...
public interface QueryableFactory<T> {
     ...
     * satisfy a condition.
     */
    boolean all(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     */
    boolean any(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     */
    int count(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     */
    T first(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     * element is found.
     */
    T firstOrDefault(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     */
    <TKey, TResult> Queryable<Grouping<TKey, TResult>> groupByK(Queryable<T> source, FunctionExpression<Function1<T, TKey>> keySelector, FunctionExpression<Function2<TKey, Enumerable<T>, TResult>> elementSelector);
     ...
     * comparer.
     */
    <TKey, TResult> Queryable<TResult> groupByK(Queryable<T> source, FunctionExpression<Function1<T, TKey>> keySelector, FunctionExpression<Function2<TKey, Enumerable<T>, TResult>> elementSelector, EqualityComparer<TKey> comparer);
     ...
     * satisfies a specified condition.
     */
    T last(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     * found.
     */
    T lastOrDefault(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     */
    long longCount(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     * specified type.
     */
    <TResult> Queryable<TResult> ofType(Queryable<T> source, Class<TResult> clazz);
     ...
     */
    <TResult> Queryable<TResult> selectN(Queryable<T> source, FunctionExpression<Function2<T, Integer, TResult>> selector);
     ...
     */
    <TResult> Queryable<TResult> selectManyN(Queryable<T> source, FunctionExpression<Function2<T, Integer, Enumerable<TResult>>> selector);
     ...
     */
    <TCollection, TResult> Queryable<TResult> selectMany(Queryable<T> source, FunctionExpression<Function2<T, Integer, Enumerable<TCollection>>> collectionSelector, FunctionExpression<Function2<T, TCollection, TResult>> resultSelector);
     ...
     */
    T single(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     */
    T singleOrDefault(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     * elements.
     */
    Queryable<T> skipWhile(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     */
    Queryable<T> takeWhile(Queryable<T> source, FunctionExpression<Predicate<T>> predicate);
     ...
     * predicate.
     */
    Queryable<T> where(Queryable<T> source, FunctionExpression<? extends Predicate<T>> predicate);
