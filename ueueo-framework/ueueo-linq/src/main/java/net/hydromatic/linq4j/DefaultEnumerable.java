...
/**
 * Implementation of the {@link Enumerable} interface that
...
public abstract class DefaultEnumerable<T> implements OrderedEnumerable<T> {
  ...
  @Override
  public long longCount(Predicate<T> predicate) {
  ...
  @Override
  public Enumerable<T> skipWhile(Predicate<T> predicate) {
  ...
  @Override
  public Enumerable<T> takeWhile(Predicate<T> predicate) {
