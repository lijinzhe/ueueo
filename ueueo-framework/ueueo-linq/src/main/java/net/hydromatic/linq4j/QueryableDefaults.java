...
public abstract class QueryableDefaults {
     ...
     * satisfy a condition.
     */
    public static <T> boolean all(Queryable<T> queryable, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     */
    public static <T> boolean any(Queryable<T> queryable, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     */
    public static <T, T2> Queryable<T2> cast(final Queryable<T> source, final Class<T2> clazz) {
        return new BaseQueryable<T2>(source.getProvider(), clazz, source.getExpression()) {
            @Override
            public Enumerator<T2> enumerator() {
                return new EnumerableDefaults.CastingEnumerator<T2>(source.enumerator(), clazz);
            }
        };
    }
     ...
     */
    public static <T> int count(Queryable<T> queryable, FunctionExpression<Predicate<T>> func) {
        throw Extensions.todo();
    }
     ...
     */
    public static <T> T first(Queryable<T> queryable, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     * element is found.
     */
    public static <T> T firstOrDefault(Queryable<T> queryable, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     * satisfies a specified condition.
     */
    public static <T> T last(Queryable<T> queryable, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     * found.
     */
    public static <T> T lastOrDefault(Queryable<T> queryable, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     */
    public static <T> long longCount(Queryable<T> queryable, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
    ...
    public static <T, TResult> Queryable<TResult> select(Queryable<T> source, FunctionExpression<Function1<T, TResult>> selector) {
        return source.getProvider().createQuery(Expressions.call(source.getExpression(), "select", selector), functionResultType(selector));
    }

    private static <P0, R> Type functionResultType(FunctionExpression<Function1<P0, R>> selector) {
     ...
     * {@link #select(Queryable, FunctionExpression)}.</p>
     */
     ...
     * {@link #selectMany(Queryable, FunctionExpression)}</p>
     */
     ...
     *
     * <p>NOTE: Renamed from {@code selectMany} because had same erasure as
     * {@link #selectMany(Queryable, FunctionExpression, FunctionExpression)}</p>
     */
     ...
     */
    public static <T> T single(Queryable<T> source, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     */
    public static <T> T singleOrDefault(Queryable<T> source, FunctionExpression<Predicate<T>> predicate) {
        throw Extensions.todo();
    }
     ...
     * elements.
     */
    public static <T> Queryable<T> skipWhile(Queryable<T> source, FunctionExpression<Predicate<T>> predicate) {
        return skipWhileN(source, Expressions.lambda(Functions.<T, Integer>toPredicate2(predicate.getFunction())));
    }
     ...
     * predicate function.
     */
    public static <T> Queryable<T> skipWhileN(final Queryable<T> source, final FunctionExpression<Predicate2<T, Integer>> predicate) {
        return new BaseQueryable<T>(source.getProvider(), source.getElementType(), source.getExpression()) {
            @Override
            public Enumerator<T> enumerator() {
                return new EnumerableDefaults.SkipWhileEnumerator<T>(source.enumerator(), predicate.getFunction());
            }
        };
    }
     ...
     */
    public static <T> Queryable<T> takeWhile(Queryable<T> source, FunctionExpression<Predicate<T>> predicate) {
        return takeWhileN(source, Expressions.lambda(Functions.<T, Integer>toPredicate2(predicate.getFunction())));
    }
     ...
     */
    public static <T> Queryable<T> takeWhileN(final Queryable<T> source, final FunctionExpression<Predicate2<T, Integer>> predicate) {
        return new BaseQueryable<T>(source.getProvider(), source.getElementType(), source.getExpression()) {
            @Override
            public Enumerator<T> enumerator() {
                return new EnumerableDefaults.TakeWhileEnumerator<T>(source.enumerator(), predicate.getFunction());
            }
        };
    }
     ...
     * predicate.
     */
    public static <T> Queryable<T> where(final Queryable<T> source, final FunctionExpression<Predicate<T>> predicate) {
    ...
    public abstract static class ReplayableQueryable<T> extends DefaultQueryable<T> implements Replayable<T> {
        @Override
        public void replay(QueryableFactory<T> factory) {
        }
    ...
    public abstract static class NonLeafReplayableQueryable<T> extends ReplayableQueryable<T> {
