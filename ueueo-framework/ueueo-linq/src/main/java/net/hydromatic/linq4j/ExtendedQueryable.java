...
interface ExtendedQueryable<TSource> extends ExtendedEnumerable<TSource> {
     ...
     * satisfy a condition.
     */
    boolean all(FunctionExpression<Predicate<TSource>> predicate);

    /**
     * Determines whether any element of a sequence
     * satisfies a condition.
     */
    boolean any(FunctionExpression<Predicate<TSource>> predicate);
     ...
     */
    int count(FunctionExpression<Predicate<TSource>> predicate);
     ...
     */
    TSource first(FunctionExpression<Predicate<TSource>> predicate);
     ...
     * element is found.
     */
    TSource firstOrDefault(FunctionExpression<Predicate<TSource>> predicate);
     ...
     * satisfies a specified condition.
     */
    TSource last(FunctionExpression<Predicate<TSource>> predicate);
     ...
     * found.
     */
    TSource lastOrDefault(FunctionExpression<Predicate<TSource>> predicate);

    /**
     * Returns an long that represents the number of
     * elements in a sequence that satisfy a condition.
     */
    long longCount(FunctionExpression<Predicate<TSource>> predicate);
     ...
     * value.
     */
    <TResult extends Comparable<TResult>> TResult min(FunctionExpression<Function1<TSource, TResult>> selector);
     ...
     *
     * <p>NOTE: Renamed from {@code selectMany} because had same erasure as
     * {@link #selectMany(FunctionExpression, FunctionExpression)}</p>
     */
     ...
     */
    TSource single(FunctionExpression<Predicate<TSource>> predicate);
     ...
     */
    TSource singleOrDefault(FunctionExpression<Predicate<TSource>> predicate);
     ...
     * elements.
     */
    Queryable<TSource> skipWhile(FunctionExpression<Predicate<TSource>> predicate);
     ...
     */
    Queryable<TSource> takeWhile(FunctionExpression<Predicate<TSource>> predicate);
     ...
     * predicate.
     */
    Queryable<TSource> where(FunctionExpression<? extends Predicate<TSource>> predicate);
