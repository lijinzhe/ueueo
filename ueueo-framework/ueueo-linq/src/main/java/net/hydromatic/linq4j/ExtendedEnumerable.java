...
public interface ExtendedEnumerable<TSource> {
     ...
     * satisfy a condition.
     */
    boolean all(Predicate<TSource> predicate);
     ...
     */
    TSource first(Predicate<TSource> predicate);
     ...
     * </table>
     */
    <TInner, TKey, TResult> Enumerable<TResult> join(Enumerable<TInner> inner, Function1<TSource, TKey> outerKeySelector, Function1<TInner, TKey> innerKeySelector, Function2<TSource, TInner, TResult> resultSelector, EqualityComparer<TKey> comparer, boolean generateNullsOnLeft, boolean generateNullsOnRight);
     ...
     * satisfies a specified condition.
     */
    TSource last(Predicate<TSource> predicate);
     ...
     * found.
     */
    TSource lastOrDefault(Predicate<TSource> predicate);
     ...
     */
    long longCount(Predicate<TSource> predicate);
     ...
     */
    TSource single(Predicate<TSource> predicate);
     ...
     */
    TSource singleOrDefault(Predicate<TSource> predicate);
     ...
     * elements.
     */
    Enumerable<TSource> skipWhile(Predicate<TSource> predicate);
     ...
     */
    Enumerable<TSource> takeWhile(Predicate<TSource> predicate);
     ...
     * predicate.
     */
    Enumerable<TSource> where(Predicate<TSource> predicate);
