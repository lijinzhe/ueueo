...
public abstract class Expressions {
     ...
     */
    public static <F> FunctionExpression<F> lambda(
            F function) {
     ...
     * type.
     */
    public static <F> FunctionExpression<F> lambda(BlockStatement body, Iterable<? extends ParameterExpression> parameters) {
     ...
     * type, using varargs.
     */
    public static <F> FunctionExpression<F> lambda(BlockStatement body, ParameterExpression... parameters) {
     ...
     */
    public static <F> FunctionExpression<F> lambda(Expression body, Iterable<? extends ParameterExpression> parameters) {
     ...
     */
    public static <F> FunctionExpression<F> lambda(Expression body, ParameterExpression... parameters) {
     ...
     */
    public static <T, F> FunctionExpression<F> lambda(Class<F> type, BlockStatement body,
     ...
     * <p>It can be used when the delegate type is not known at compile time.
     */
    public static <F> FunctionExpression<F> lambda(Class<F> type, Expression body, Iterable<? extends ParameterExpression> parameters) {
     ...
     * <p>It can be used when the delegate type is not known at compile time.
     */
    public static <T, F> FunctionExpression<F> lambda(Class<F> type, Expression body, ParameterExpression... parameters) {
        return lambda(type, Blocks.toFunctionBlock(body), toList(parameters));
    }
    ...
    private static Class deduceType(List<ParameterExpression> parameterList,
        ...
        switch (parameterList.size()) {
            ...
            case 1:
                return type == Boolean.TYPE ? Predicate.class : Function1.class;
            case 2:
