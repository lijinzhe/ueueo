...
public sealed class NullDistributedEventBus : IDistributedEventBus
{
    ...
    public void PublishAsync<TEvent>(TEvent eventData, boolean onUnitOfWorkComplete = true) //where TEvent : class
    {
    ...
    public void PublishAsync<TEvent>(TEvent eventData, boolean onUnitOfWorkComplete = true, boolean useOutbox = true) where TEvent : class
    {
        return Task.CompletedTask;
    }

    public void PublishAsync(Type eventType, Object eventData, boolean onUnitOfWorkComplete = true, boolean useOutbox = true)
    {
        return Task.CompletedTask;
    }
}
