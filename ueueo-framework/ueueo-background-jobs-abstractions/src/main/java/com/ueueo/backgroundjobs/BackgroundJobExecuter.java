...
public class BackgroundJobExecuter implements IBackgroundJobExecuter {
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            throw new AbpException("The job type is not registered to DI: " + context.getJobType());
        }
        ...
        if (jobExecuteMethod == null) {
            throw new AbpException("Given job type does not implement IBackgroundJob or IAsyncBackgroundJob. " +
