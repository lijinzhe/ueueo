...
# Identity Server Module (Commercial)
...
![identity-server-clients-page](docs/images/identity-server-clients-page-2.png)

You can create new clients or edit existing clients in this page:

![identity-server-edit-client-modal](docs/images/identity-server-edit-client-modal-2.png)
...
![identity-server-identity-resources-page](docs/images/identity-server-identity-resources-page-2.png)

You can create a new identity resource or edit an existing identity resource in this page:

![identity-server-edit-identity-resource-modal](docs/images/identity-server-edit-identity-resource-modal-2.png)
...
![identity-server-api-resources-page](docs/images/identity-server-api-resources-page-2.png)

You can create a new API resource or edit an existing API resource in this page:

![identity-server-edit-api-resource-modal](docs/images/identity-server-edit-api-resource-modal-2.png)
