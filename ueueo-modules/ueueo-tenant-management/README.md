...
![module-tenant-management-page](docs/images/module-tenant-management-page.png)

In this page, you see the all the tenants. You can create a new tenant as shown below:

![module-tenant-management-new-tenant](docs/images/module-tenant-management-new-tenant.png)
...
![module-tenant-management-actions](docs/images/module-tenant-management-actions.png)
