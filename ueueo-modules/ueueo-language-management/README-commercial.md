...
![language-management-languages-page](docs/images/language-management-languages-page-2.png)

You can create a new language or edit an existing language in this page:

![language-management-edit-language-modal](docs/images/language-management-edit-language-modal-2.png)
...
![language-management-language-texts-page](docs/images/language-management-language-texts-page-2.png)

You can translate a text for a language or edit the already existing translation in this page.

![language-management-edit-language-text-modal](docs/images/language-management-edit-language-text-modal-2.png)
