 ...
 */
public interface IBasicRepository<TEntity extends IEntity<TKey>,TKey> extends IReadOnlyBasicRepository<TEntity,TKey> {
    /**
     ...
     * @param autoSave
     */
    void deleteById(TKey id, Boolean autoSave);
     ...
     *                 but you need to immediately save changes to the database.
     */
    void deleteManyByIds(Collection<TKey> ids, Boolean autoSave);
